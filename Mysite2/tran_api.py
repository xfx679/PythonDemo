...
url_for_tran = 'https://api-lyprice.xin.com/tpl/getBatchData'

#  物流价格接口参数：城市
params_tran = {"cityList": "1814-708", "source": "app"}
...
def get_version():
    """获取物流版本号"""
    params = {'source': 'pc'}
    url = 'http://feature1-api-lyprice.fat.xin.com/tpl/getDataVerion '
    token1 = createSn(test_key, params)
    params.update(token=token1)
